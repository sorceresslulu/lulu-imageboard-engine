...
define('LI_MYSQL_APPLICATION_CONFIG_PATH', __DIR__.'/config');

class MysqlApplication implements ApplicationInterface
{
    /**
     * Configuration
     * @var array
    ...
    public function __construct(ServiceManagerInterface $serviceManager, array $configuration) {
        ...
        $this->configuration = array_merge_recursive($configuration, [
            'factories' => require LI_MYSQL_APPLICATION_CONFIG_PATH.'/factories.php'
        ]);
    }
